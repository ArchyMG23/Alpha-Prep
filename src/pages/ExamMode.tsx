...
import { CheckCircle2, AlertCircle, PenTool, BookOpen, Headphones, HelpCircle, ArrowLeft, Send, Sparkles, Lock, X, Play, ChevronRight, GraduationCap } from 'lucide-react';
